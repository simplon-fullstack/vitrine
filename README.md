...
## EXERCICES EN JS
    ...
    ACCEDER A LA VALEUR D'UN CHAMP input
    => UTILISER L'ATTRIBUT     .value

    POUR FAIRE CHAQUE EXO
    CREER UN FICHIER html PAR EXO

### EXO 1 : PRIX TTC

    DANS UN CHAMP INPUT, ON ENTRE UN PRIX HT
    EN QUAND ON CLIQUE SUR LE BOUTON "CALCULER TTC"
    ON VEUT VOIR DANS UN BALISE div EN DESSOUS, LE PRIX TTC

    CREER UN FICHIER exo1.html
    AJOUTER LE CODE HTML POUR AVOIR UNE PAGE WEB
    ET AJOUTER LE CODE POUR AVOIR
    input       => ENTRER LE PRIX HT
    button      => QUAND ON CLIQUE SUR LE BOUTON ON VEUT VOIR LE PRIX TTC
    div         => AFFICHER LE PRIX TTC

    BONUS:
    AJOUTER UN CHAMP input POUR ENTRER LE TAUX DE TVA
    (VALEUR PAR DEFAUT 20)
    ET CALCULER LE PRIX TTC EN FONCTION DU TAUX TVA CHOISI


### EXO 2 : SURFACE DES MURS
...
### EXO 3 : DISTRIBUTEUR DE BILLETS
    ...
    ASTUCE: COMMENCER PAR COMPRENDRE COMMENT UN ETRE HUMAIN FAIT POUR REALISER CET EXERCICE

    CREER UN FICHIER exo3.html
...
### EXO 4 : DAMIER
    ...
    DESSINER UN DAMIER
    CHAMP input POUR ENTRER LE NOMBRE DE CASES PAR COTE
    button  "DESSINER LE DAMIER"
    div POUR AFFICHER LE DAMIER

    Par Exemple: si on entre 3
